...
namespace Challenge.RealStates.Infrastructure.Data.Repositories
{
    public class ZapRepository : IZapRepository
    {
        private readonly IOptions<DataInMemory> _dataInMemory;

        public ZapRepository(IOptions<DataInMemory> dataInMemory)
        {
